...
export default function Openings(){
  ...
  return <section>
    <h1 className="text-4xl font-bold text-text-primary md:text-5xl">{BRAND_NAMES.openingTrainer}</h1>
    <p className="mt-4 max-w-3xl text-text-secondary">Học ý tưởng khai cuộc và luyện các nước đầu tiên cho chắc tay.</p>
