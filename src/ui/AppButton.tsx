...
export const AppButton = React.forwardRef<HTMLButtonElement, AppButtonProps>(
  (
    ...
    const variantStyles: Record<string, string> = {
      primary: 'bg-[var(--app-accent)] text-[#0C100E] font-semibold hover:bg-[var(--app-accent-hover)] active:bg-[var(--app-accent-pressed)] border border-transparent shadow-sm',
