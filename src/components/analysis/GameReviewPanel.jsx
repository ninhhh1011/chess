  ...
  return (
    <article className="rounded-2xl border border-slate-700 bg-slate-800/80 p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-400/75">Review</p>
          <h2 className="mt-1 text-lg font-black text-slate-50">Engine scan</h2>
        </div>
      ...
      {!review ? (
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            <h3 className="font-black text-emerald-300">Lỗi lớn nhất</h3>
