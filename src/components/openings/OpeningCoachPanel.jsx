export default function OpeningCoachPanel({ opening }) {
  return <article className="rounded-[2rem] border border-emerald-500/20 bg-emerald-500/10 p-5 text-sm leading-7 text-cream/80">
    <h2 className="text-xl font-black text-emerald-500">Coach ghi chú</h2>
