...
export default function OpeningCard({ opening, progress }) {
  return <article className="rounded-[2rem] border border-white/10 bg-white/[.08] p-6 backdrop-blur transition hover:-translate-y-1 hover:border-emerald-500/40">
    <div className="flex flex-wrap gap-2">
      <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-xs font-black uppercase text-emerald-500">{sideLabel[opening.side]}</span>
