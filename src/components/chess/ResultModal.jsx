...
export default function ResultModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/75 px-4 backdrop-blur-sm">
      <div className="max-w-md rounded-2xl border border-emerald-400/40 bg-slate-900/95 p-8 text-center shadow-glow">
        <div className="mx-auto mb-4 grid h-16 w-16 place-items-center rounded-xl bg-emerald-500 text-4xl text-slate-950">
          ♔
        </div>
        <h2 className="text-3xl font-black text-emerald-300">Kết thúc ván đấu</h2>
