...
export default function LevelProgress({ profile, canLevelUp, nextLevel }) {
  ...
  return <div className="rounded-[2rem] border border-white/10 bg-white/[.08] p-6 backdrop-blur">
    ...
    {canLevelUp && next && <p className="mt-5 rounded-2xl bg-emerald-500/15 p-4 font-bold text-emerald-500">Bạn có vẻ đã sẵn sàng lên cấp {next.label}. Bấm nút nâng cấp để chuyển lộ trình.</p>}
  </div>;
}
