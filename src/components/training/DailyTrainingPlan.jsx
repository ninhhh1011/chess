export default function DailyTrainingPlan({ plan, onRegenerate, onStartLesson, onStartExercises, onStartOpening }) {
  return <article className="rounded-[2rem] border border-emerald-500/20 bg-gradient-to-br from-emerald-500/15 via-white/[.07] to-white/[.04] p-6 shadow-glow backdrop-blur">
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div>
        <p className="text-sm font-black uppercase tracking-[0.24em] text-emerald-500/80">Lộ trình hôm nay</p>
    ...
    <div className="mt-6 grid gap-4 lg:grid-cols-4">
      <div className="rounded-3xl bg-ink/45 p-5">
        <p className="font-black text-emerald-500">1. Học</p>
      ...
      <div className="rounded-3xl bg-ink/45 p-5">
        <p className="font-black text-emerald-500">2. Làm bài tập</p>
      ...
      <div className="rounded-3xl bg-ink/45 p-5">
        <p className="font-black text-emerald-500">3. Khai cuộc</p>
      ...
      <div className="rounded-3xl bg-ink/45 p-5">
        <p className="font-black text-emerald-500">4. Chơi</p>
