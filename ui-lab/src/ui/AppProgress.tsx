...
/**
 * AppProgress wrapper adhering to Option C tokens:
 * - Radius: 6px
 * - Pine green for default / primary progress
 * - Teal for semantic success
 * - Copper for chess highlights
 * - Full ARIA progressbar compliance
 */
